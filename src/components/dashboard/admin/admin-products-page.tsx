...
const MOCK_PRODUCTS: AdminProduct[] = [
  ...
  {
    id: "p2",
    name: "Bitter Leaf Tonic 250ml",
    category: "Tonic",
    emoji: "🍃",
    status: "PENDING_REVIEW",
    producer: "HerbalNaija",
    producerTier: "UNVERIFIED",
    batches: 1,
    approvedBatches: 0,
    sales: 0,
  ...
  },
  {
    ...
    status: "FLAGGED",
    flagReason:
      "Microbial count exceeded limits in Batch B2024-11. Producer notified.",
  ...
  {
    id: "p5",
    name: "Neem Capsules 400mg",
    category: "Capsules",
    emoji: "🌳",
    status: "BANNED",
    flagReason:
      "Internal neem oil preparation — significant toxicity risk confirmed. Permanently removed.",
    producer: "HerbalMax Nigeria",
    producerTier: "UNVERIFIED",
    batches: 1,
    approvedBatches: 0,
    sales: 0,
